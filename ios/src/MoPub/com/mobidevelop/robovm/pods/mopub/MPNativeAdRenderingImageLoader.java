...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPNativeAdRenderingImageLoader/*</name>*/ 
    ...
    public MPNativeAdRenderingImageLoader(MPNativeAdRendererImageHandler imageHandler) { super((SkipInit) null); initObject(initWithImageHandler(imageHandler)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    /*<methods>*/
    @Method(selector = "initWithImageHandler:")
    protected native @Pointer long initWithImageHandler(MPNativeAdRendererImageHandler imageHandler);
    @Method(selector = "loadImageForURL:intoImageView:")
    public native void loadImageForURL$intoImageView$(NSURL url, UIImageView imageView);
    /*</methods>*/
}
