...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/ALAdRewardDelegate/*</name>*/ 
    ...
    void rewardValidationRequestForAd$didSucceedWithResponse$(ALAd ad, NSDictionary<?, ?> response);
    @Method(selector = "rewardValidationRequestForAd:didExceedQuotaWithResponse:")
    void rewardValidationRequestForAd$didExceedQuotaWithResponse$(ALAd ad, NSDictionary<?, ?> response);
    @Method(selector = "rewardValidationRequestForAd:wasRejectedWithResponse:")
    void rewardValidationRequestForAd$wasRejectedWithResponse$(ALAd ad, NSDictionary<?, ?> response);
    @Method(selector = "rewardValidationRequestForAd:didFailWithError:")
    void rewardValidationRequestForAd$didFailWithError$(ALAd ad, @MachineSizedSInt long responseCode);
