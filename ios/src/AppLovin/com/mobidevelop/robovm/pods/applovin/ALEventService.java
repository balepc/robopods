...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/ALEventService/*</name>*/ 
    ...
    public native void trackEvent(String eventType);
    @Method(selector = "trackEvent:parameters:")
    public native void trackEvent$parameters$(String eventType, NSDictionary<?, ?> parameters);
    @Method(selector = "trackInAppPurchaseWithTransactionIdentifier:parameters:")
    public native void trackInAppPurchaseWithTransactionIdentifier$parameters$(String transactionId, NSDictionary<?, ?> parameters);
    @Method(selector = "trackCheckoutWithTransactionIdentifier:parameters:")
    public native void trackCheckoutWithTransactionIdentifier$parameters$(String transactionId, NSDictionary<?, ?> parameters);
    /*</methods>*/
}
