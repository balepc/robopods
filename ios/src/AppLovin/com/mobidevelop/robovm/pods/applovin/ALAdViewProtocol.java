...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/ALAdViewProtocol/*</name>*/ 
    ...
    ALAdLoadDelegate getAdLoadDelegate();
    @Property(selector = "setAdLoadDelegate:")
    void setAdLoadDelegate(ALAdLoadDelegate v);
    @Property(selector = "adDisplayDelegate")
    ALAdDisplayDelegate getAdDisplayDelegate();
    @Property(selector = "setAdDisplayDelegate:")
    void setAdDisplayDelegate(ALAdDisplayDelegate v);
    @Property(selector = "adEventDelegate")
    ALAdViewEventDelegate getAdEventDelegate();
    @Property(selector = "setAdEventDelegate:")
    void setAdEventDelegate(ALAdViewEventDelegate v);
    @Property(selector = "adVideoPlaybackDelegate")
    ALAdVideoPlaybackDelegate getAdVideoPlaybackDelegate();
    @Property(selector = "setAdVideoPlaybackDelegate:")
    void setAdVideoPlaybackDelegate(ALAdVideoPlaybackDelegate v);
    @Property(selector = "adSize")
    ALAdSize getAdSize();
    @Property(selector = "setAdSize:")
    void setAdSize(ALAdSize v);
