...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/AppsFlyerTracker/*</name>*/ 
    ...
    public native void setUserEmailsWithCryptType(NSArray<?> userEmails, EmailCryptType type);
    @Method(selector = "trackAppLaunch")
    public native void trackAppLaunch();
    @Method(selector = "trackEvent:withValue:")
    public native void trackEventWithValue(String eventName, String value);
    @Method(selector = "trackEvent:withValues:")
    public native void trackEventWithValues(String eventName, NSDictionary<?, ?> values);
    /**
    ...
    public native void handleOpenURLSourceApplication(NSURL url, String sourceApplication);
    @Method(selector = "handleOpenURL:sourceApplication:withAnnotation:")
    public native void handleOpenURLSourceApplicationWithAnnotation(NSURL url, String sourceApplication, NSObject annotation);
